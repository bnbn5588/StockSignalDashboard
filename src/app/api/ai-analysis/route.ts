...
{
  "generatedAt": "${today}",
  "marketSummary": "2-3 sentences describing the overall signal environment, referencing the BUY/SELL/HOLD distribution and any notable macro-level patterns",
  ...
  "portfolioNote": "1-2 sentence observation about overall portfolio health, strategy consistency, or actionable guidance"
}

Rules:
- topPicks: 1–3 tickers showing the strongest BUY conviction (long BUY streaks, high confidence, positive expectancy, strong ADX).
- riskWatch: 1–3 tickers on SELL signals, weak confidence, negative expectancy, or unusually short streaks signalling instability.
- Be specific: cite actual ticker names, signal counts, streak lengths, or % figures from the data.
